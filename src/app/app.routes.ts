    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/ortography-page/ortography-page.component'
          ),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/pros-and-cons-page/pros-and-cons-page.component'
          ),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/pros-and-cons-stream-page/pros-and-cons-stream-page.component'
          ),
        data: {
